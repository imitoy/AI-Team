-- roles.lua: Unified roles module with all role definitions
--
-- Each role configuration contains: {name, system_prompt, tools={tool_names...}, provider, model}
--
-- Usage:
--   local roles = require("roles")
--   for _, role in ipairs(roles) do
--       print(role.name, role.system_prompt)
--   end
