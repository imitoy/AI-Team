...
class OpenAIAPI:
    """Wraps an OpenAI-compatible chat completions endpoint with tool dispatch."""
    ...
    def __init__(self, model_key: str, role_name: str):
        ...
        self.tools_index: dict[str, str] = {}  # maps tool "function.name" → tool registry name
        ctools = []
    ...
    def send(self):
        ...
        while True:
            ...
            if message.tool_calls:
                ...
                # Reasoning-only response, continue
                break
